...
def generate_launch_description():
    ...
    declare_x_arg = DeclareLaunchArgument(
        "x", default_value="-14.0", description="Initial robot position in the global 'x' axis."
    )

    y = LaunchConfiguration("y")
    declare_y_arg = DeclareLaunchArgument(
        "y", default_value="-8.0", description="Initial robot position in the global 'y' axis."
    )
